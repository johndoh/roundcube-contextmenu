        ...
        if (rcmail.env.task == 'mail' && rcmail.env.action == '') {
            ...
            rcmail.contextmenu.settings_menus([
                ...
                { obj: 'sections-table tr', props: { menu_name: 'preferenceslist', menu_source: '#rcmsettings-menu > ul', list_object: 'sections_list' } },
                {
                    ...
                    props: {
                        menu_name: 'folderlist', menu_source: ['#rcmfolder-menu > ul', '#rcmsettings-menu > ul', '#toolbar-menu'], list_object: 'subscription_list', init_func: 'init_settings',
                    },
                },
                ...
                { obj: 'filterslist tr', props: { menu_name: 'managesieverulelist', menu_source: ['#rcmsettings-menu > ul', '#toolbar-menu'], list_object: 'filters_list' } },
                {
                    obj: 'keys-table tr',
                    props: {
                        menu_name: 'enigmakeylist', menu_source: ['#rcmsettings-menu > ul', '#toolbar-menu'], list_object: 'keys_list', list_id: 'keys-table',
                    },
                },
            ]);
        }
