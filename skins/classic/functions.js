...
$(document).ready(function() {
	if (window.rcmail) {
		if (rcmail.env.task == 'mail' && rcmail.env.action == '') {
			...
			rcmail.add_onload("rcm_foldermenu_init('#mailboxlist li', '#mailboxoptionsmenu ul')");
		...
		if (rcmail.env.task == 'addressbook' && rcmail.env.action == '') {
			...
			rcmail.add_onload("rcm_abookmenu_init('#directorylist li.addressbook', '#directorylist-footer')");
			rcmail.add_onload("rcm_groupmenu_init('#directorylist ul.groups li', '#groupoptionsmenu ul')");
